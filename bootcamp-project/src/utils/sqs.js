...
function cartStatusChange({ date, id, cantidad }) {
    let objTo = { date, id, cantidad };
    var params = {
        // Remove DelaySeconds parameter and value for FIFO queues
        // DelaySeconds: 10,
        MessageAttributes: {
            ...
            Cantidad: {
                DataType: "String",
                StringValue: cantidad,
            },
        },
        MessageBody: `${objTo}`,
        // MessageDeduplicationId: "TheWhistler",  // Required for FIFO queues
        // MessageGroupId: "Group1",  // Required for FIFO queues
        QueueUrl: "http://localstack:4576/000000000000/estadisticas",
    };
...
module.exports = { sendMessageToQueue, cartStatusChange };
